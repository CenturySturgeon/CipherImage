    ...
    while True:
        ...
        try:
            ...
            if value == default:
                ...
                confirmation_input = click.prompt("Repeat for confirmation", hide_input=True)
...
def prompt_for_string(default: str) -> str:
    """Prompts the user for a string. If he hits enter, the default value is returned, else he is prompted to confirm his input."""
    while True:
        user_input = click.prompt("Salt", default=str(default), hide_input=True, confirmation_prompt=False)
        if not user_input.strip():  # If user hits Enter
            return default
        try:
            ...
            click.echo("Please enter a valid string.")
