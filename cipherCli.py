...
@click.option('--salt', default='salt_', hide_input=True, confirmation_prompt=True, help='A string value used to add randomness to the encryption process (ideally, each salt should be random and unique).')
@click.option('--iterations', default=100000, hide_input=True, confirmation_prompt=True, help='A higher number of iterations increases the computational cost of deriving the key, making it harder to decrypt.')
...
@click.option('--salt', default='salt_', hide_input=True, help='The value used to add randomness to the encryption process (the same used when encrypting the password).')
@click.option('--iterations', default=100000, hide_input=True, help='The number of iterations to derive the secret key (the same used when encrypting the password).')
